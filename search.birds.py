...
if __name__ == '__main__':
    ...
    parser.add_argument('--dset', type=str, default='birds', choices=['office', 'home', 'domainnet', 'birds'], help="The dataset used")
    parser.add_argument('--task', type=str, default='I2C', help="task source 2 target")
